...
namespace InlamingsUppgiftDBKurs
{
    ...
    public partial class EditPlayerForm : Form
    {
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        comboboxPlayerPosition.Text = reader.GetString(5);
                        comboBoxLeague.Text = reader.GetString(6);
                        comboBoxTeam.Text = reader.GetString(7);
                        comboBoxCountry.Text = reader.GetString(8);
                        txtboxPhonenumber.Text = reader.GetString(9);
                        txtboxEmailAdress.Text = reader.GetString(10);
                    }
                }
                else
                {
        ...
        private void UpdatePlayerToDB()
        {
            ...
            string sqlQuery = $"CALL updatePlayer({playerId}, '{playerFirstName}', '{playerLastName}', {playerAge}, {playerNumber}, {playerPosition}, {playerLeague}, {playerTeam}, {playerCountry});";
